...
#define DISPLAY_MAX_X_LENGTH		800//LCD_DEFAULT_WIDTH
#define DISPLAY_MAX_Y_LENGTH		480//LCD_DEFAULT_HEIGHT

#define DISPLAY_HEAD_HEIGHT			(24)
#define DISPLAY_AERAS1_HEIGHT		(68 * 2)
#define DISPLAY_AERAS2_HEIGHT		(68 * 2)
#define DISPLAY_AERAS3_HEIGHT		(24)
